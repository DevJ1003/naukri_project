            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="hero-cap text-center">
                        <h2><i class="far fa-address-book" style="font-size:240px;"></i> Update <?php echo $candidate_name; ?>'s Profile...!!</h2>
                    </div>
                </div>
            </div>
        </div>
...
<div id="page-wrapper" style="text-align: -webkit-center;">
    ...
    <h1 class="page-header"><i class="fa fa-fw fa-table"></i>
        <?php echo $candidate_name; ?>'s Profile...!!
    </h1>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <button name="update" type="submit" class="btn head-btn2">Update Candidate profile !<span class="glyphicon glyphicon-ok"></span></button>
            </div>
